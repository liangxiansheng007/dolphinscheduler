...
//            logger.warn(" #####  OSUtils memoryUsage is invlidate, isOffInLinux value : {}", isOffInLinux);
            return 0.5;
        }
    ...
    public static double diskAvailable() {
        ...
        if ("true".equals(isOffInLinux)) {
//            logger.warn(" #####  OSUtils diskAvailable is invlidate, isOffInLinux value : {}", isOffInLinux);
            return 0.5;
        }
    ...
    public static double availablePhysicalMemorySize() {
        if ("true".equals(isOffInLinux)) {
//            logger.warn(" #####  OSUtils availablePhysicalMemorySize is invlidate, isOffInLinux value : {}",
//                    isOffInLinux);
            return 0.5;
        }
        GlobalMemory memory = hal.getMemory();
    ...
    public static double loadAverage() {
        ...
        if ("true".equals(isOffInLinux)) {
//            logger.warn(" #####  OSUtils loadAverage is invlidate, isOffInLinux value : {}", isOffInLinux);
            return 0.5;
        }
    ...
    public static double cpuUsage() {
        ...
        if ("true".equals(isOffInLinux)) {
//            logger.warn(" #####  OSUtils cpuUsage is invlidate, isOffInLinux value : {}", isOffInLinux);
            return 0.5;
        }
    ...
    public static List<String> getUserList() {
        ...
        if ("true".equals(isOffInLinux)) {
//            logger.warn(" #####  OSUtils getUserList is invlidate, isOffInLinux value : {}", isOffInLinux);
    ...
    public static boolean existTenantCodeInLinux(String tenantCode) {
        ...
        if ("true".equals(isOffInLinux)) {
//            logger.warn(" #####  OSUtils existTenantCodeInLinux is invlidate, isOffInLinux value : {}", isOffInLinux);
            return true;
        }
    ...
    public static String getGroup() throws IOException {
        if (SystemUtils.IS_OS_WINDOWS) {
            ...
            if ("true".equals(isOffInLinux)) {
//                logger.warn(" #####  OSUtils getGroup is invlidate, isOffInLinux value : {}", isOffInLinux);
                return "root";
            }
